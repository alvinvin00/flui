...
class FLToast {
  static Function loading({required String text}) =>
      FLToast.showLoading(text: text);
  ...
  static Function show(
          {required String text, FLToastContentBuilder? contentBuilder}) =>
  ...
  static void success({required String text}) =>
      FLToast.showSuccess(text: text);
