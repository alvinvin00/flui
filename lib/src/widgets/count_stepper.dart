...
class _FLCountStepperState extends State<FLCountStepper> {
  ...
  void _syncValueAndInput() {
    ...
    if ((_controller.value?.compareTo(num.parse(text)) ?? 0) != 0) {
  ...
  Widget build(BuildContext context) {
    ...
    final Color buttonIconColor = widget.actionColor ??
        (isDarkMode ? Colors.white : themeData.primaryColor);
    ...
    final Widget minusButton = Container(
      ...
      child: TextButton(
        style: ButtonStyle(
          ...
          foregroundColor: MaterialStateProperty.all<Color>(buttonIconColor),
        ),
        child: Icon(Icons.remove, size: _kDefaultEleSize),
    ...
    final Widget addButton = Container(
      ...
      child: TextButton(
        style: ButtonStyle(
          ...
          foregroundColor: MaterialStateProperty.all(buttonIconColor),
        ),
        child: Icon(Icons.add, size: _kDefaultEleSize),
        //Text('+', textAlign: TextAlign.center, style: TextStyle(fontSize: 18)),
